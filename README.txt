...
Тестовое задание на должность "Инженер по автоматизации тестирования/QA Automation Engineer" в фирму Social Quantum

Задание:
-Написать автотесты, используя junit, для объекта (интерфейса) Square;
...
Директория отчёта: \SquareTest\target\site (создается при вводе "mvn site")
